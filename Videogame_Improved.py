...
def draw_text(text, x, y, color=BLUE):
...
def selection_screen():
    ...
    while running:
        ...
        draw_text("Press LEFT/RIGHT to change", WIDTH // 4, HEIGHT // 2 + 50, GRAY)
        draw_text("Press ENTER to start", WIDTH // 4, HEIGHT // 2 + 100, GRAY)
        draw_text("Player 1 controls: A W D  Player 2 controls: Arrow Keys", WIDTH // 4, 50, GRAY)
        draw_text("Player 3 controls: J I L  Player 4 controls: F T H", WIDTH // 4, 150, GRAY)
        draw_text("Objective:Get to the other side of the room", WIDTH // 4, 225, GRAY)
